...
{
    public static async Task<double> MeasureAsync(XrayProfileConfiguration configuration, IPAddress address, string runtime, string path, CancellationToken cancellationToken, bool useHttps = true, string? outboundSourceAddress = null)
    {
        ...
        listener.Stop();
        var content = configuration.Build(address.ToString(), false, port, outboundSourceAddress: outboundSourceAddress).Replace("\"loglevel\":\"none\"", "\"loglevel\":\"info\"");
